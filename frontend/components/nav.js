function navbar(){
    ...
    <div id="navlabel">
        <label><a class="navlabels" href="#">Become a host</a></label>
        
         <label><a id="zms" class="navlabels" href="#">ZMS</a></label>

         <label id="signup"><a  id="profile_name" class="navlabels" href="#">Login/Signup</a></label>
