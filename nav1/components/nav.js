function navbar(){
    ...
    <div id="navlabel">
        <label><a class="navlabels" href="/earnings/earning.html">Start Earning</a></label>
        
         <label><a class="navlabels" href="#">ZMS</a></label>

         <label id="signup"><a  id="profile_name" class="navlabels" href="#">Signup/Login</a></label>
